...
def main(correct_ans):
    ...
    GREEN = (0, 255, 0)
    BROWN = (122, 49, 0)
    pygame.display.set_caption("Programming Principles")   
...
#button class
    ...
    #linear algebruh
    img_1 = pygame.image.load('assets/quiz/pp1.png').convert_alpha()
    button1 = Button(290, 540, img_1, 1)

    img_2 = pygame.image.load('assets/quiz/pp2.png').convert_alpha()
    button2 = Button(290, 640, img_2, 1)
    
    img_3 = pygame.image.load('assets/quiz/pp3.png').convert_alpha()
    button3 = Button(700, 540, img_3, 1)

    img_4 = pygame.image.load('assets/quiz/pp4.png').convert_alpha()
    ...
    bg1 = pygame.image.load('assets/quiz/P4.png')
